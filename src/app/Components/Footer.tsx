      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Fielduo</h3>
            <p className="text-gray-400 mb-6">
              Delivering innovative solutions with trust and excellence. We turn your vision into reality with creativity and professionalism.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">Fielduo, Inc 
2261 Market Street
#86773
San Francisco, CA 94114</span>
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">info@fielduo.com</span>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex w-full md:w-auto">
              <input 
                ...
                className="bg-gray-900 border border-gray-800 text-white rounded-l-lg p-3 focus:outline-none focus:ring-2 focus:ring-blue-500 w-full md:w-64"
              />
              <button className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-bold py-3 px-6 rounded-r-lg transition-all duration-300">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 pt-8 text-center">
          <p className="text-gray-400">© 2025 Fielduo. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
